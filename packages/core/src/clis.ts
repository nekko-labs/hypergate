import type { CliTool } from '@hypergate/shared';

/**
 * Command-line tools Hypergate knows about — the ones that MCP servers commonly
...
export const KNOWN_CLIS: CliTool[] = [
  ...
  { id: 'bun', name: 'Bun', command: 'bun', category: 'runtime', description: 'Fast JS runtime; Hypergate itself runs under it.', homepage: 'https://bun.sh', install: 'https://bun.sh' },
  ...
  { id: 'docker', name: 'Docker', command: 'docker', category: 'container', description: "Container engine — powers Hypergate's opt-in Docker isolation and the GCP Toolbox entry.", homepage: 'https://www.docker.com', install: 'https://docs.docker.com/get-docker/' },
